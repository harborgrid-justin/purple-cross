...
export class PaymentPlanService {
  ...
  async createPaymentPlan(data: {
    ...
    await this.prisma.paymentPlanInstallment.createMany({
      data: installments,
    });
  ...
  async getDueInstallments(clientId: string) {
    return this.prisma.paymentPlanInstallment.findMany({
      where: {
        paymentPlan: {
          clientId,
          status: 'active',
  ...
  async updatePaymentPlan(id: string, data: any) {
    return this.prisma.paymentPlan.update({ where: { id }, data });
  }

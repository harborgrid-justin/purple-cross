...
describe('ClientService', () => {
    ...
    describe('createClient', () => {
        ...
        it('should throw error when email already exists', async () => {
            ...
            await expect(clientService.createClient(clientData)).rejects.toThrow('Client with this email already exists');
        });
    });
    ...
    describe('getAllClients', () => {
        ...
        it('should filter clients by search term', async () => {
            ...
            expect(database_1.prisma.client.findMany).toHaveBeenCalledWith(expect.objectContaining({

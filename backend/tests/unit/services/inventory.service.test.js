...
describe('InventoryService', () => {
    ...
    describe('getInventoryItemById', () => {
        ...
        it('should throw error when item not found', async () => {
            ...
            await expect(inventoryService.getInventoryItemById(itemId)).rejects.toThrow('Inventory item not found');
        });
    });
    describe('getAllInventoryItems', () => {
        ...
        it('should filter items by category', async () => {
            ...
            expect(database_1.prisma.inventoryItem.findMany).toHaveBeenCalledWith(expect.objectContaining({
    ...
    describe('updateInventoryItem', () => {
        ...
        it('should throw error when updating non-existent item', async () => {
            const itemId = 'non-existent';
            database_1.prisma.inventoryItem.findUnique.mockResolvedValue(null);
            await expect(inventoryService.updateInventoryItem(itemId, {})).rejects.toThrow('Inventory item not found');
        });
    });

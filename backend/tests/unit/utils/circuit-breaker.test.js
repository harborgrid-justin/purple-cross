...
describe('CircuitBreaker', () => {
  let breaker;
  beforeEach(() => {
    breaker = (0, circuit_breaker_1.createCircuitBreaker)('test-breaker', {
      failureThreshold: 3,
      successThreshold: 2,
      timeout: 1000,
    });
...
describe('createCircuitBreaker', () => {
  it('should create circuit breaker with default config', () => {
    const breaker = (0, circuit_breaker_1.createCircuitBreaker)('test');
    const stats = breaker.getStats();
  ...
  it('should create circuit breaker with custom config', () => {
    ...
    expect(breaker).toBeInstanceOf(circuit_breaker_1.CircuitBreaker);
  });
});

...
describe('Clinical Note Templates', () => {
  ...
  it('should display Note Types card', () => {
    cy.visitMedicalRecordsPage('clinical-notes');
  ...
  it('should navigate back to all records from clinical notes page', () => {
    cy.visitMedicalRecordsPage('clinical-notes');

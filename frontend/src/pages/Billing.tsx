  ...
  return (
    <div className="page">
      ...
      <Suspense fallback={<div role="status"><p>Loading...</p></div>}>
        ...
        <Link to="/billing" className="sub-nav-link active">
          Invoices
        </Link>
        <Link to="/billing/invoice-generation" className="sub-nav-link">
          Invoice Generation
        </Link>
        <Link to="/billing/payment-processing" className="sub-nav-link">
          Payment Processing
        </Link>
        <Link to="/billing/insurance-claims" className="sub-nav-link">
          Insurance Claims
        </Link>
        <Link to="/billing/estimates" className="sub-nav-link">
          Estimates & Quotes
        </Link>
        <Link to="/billing/payment-plans" className="sub-nav-link">
          Payment Plans
        </Link>
        <Link to="/billing/receivables" className="sub-nav-link">
          Receivables
        </Link>
        <Link to="/billing/financial-reports" className="sub-nav-link">
          Financial Reports
        </Link>
        <Link to="/billing/refunds" className="sub-nav-link">
          Refunds & Credits
        </Link>
      </nav>

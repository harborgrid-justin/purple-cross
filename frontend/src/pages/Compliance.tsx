/**
 * WF-COMP-XXX | Compliance.tsx - Compliance
 * Purpose: React component for Compliance functionality
 * Dependencies: react
...
const HIPAA = lazy(() => import('./compliance/HIPAA'));
const Licenses = lazy(() => import('./compliance/Licenses'));
const ControlledSubstances = lazy(() => import('./compliance/ControlledSubstances'));
const RecordRetention = lazy(() => import('./compliance/RecordRetention'));
const IncidentReporting = lazy(() => import('./compliance/IncidentReporting'));
const Policies = lazy(() => import('./compliance/Policies'));
const AuditPrep = lazy(() => import('./compliance/AuditPrep'));
const Updates = lazy(() => import('./compliance/Updates'));
const ComplianceCreate = lazy(() => import('./compliance/ComplianceCreate'));
const ComplianceDetail = lazy(() => import('./compliance/ComplianceDetail'));
const ComplianceEdit = lazy(() => import('./compliance/ComplianceEdit'));

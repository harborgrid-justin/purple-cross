  ...
  return (
    <div className="page">
      ...
      <Suspense fallback={<div role="status"><p>Loading...</p></div>}>
        ...
        <Link to="/documents" className="sub-nav-link active">
          All Documents
        </Link>
        <Link to="/documents/storage" className="sub-nav-link">
          Document Storage
        </Link>
        <Link to="/documents/templates" className="sub-nav-link">
          Templates
        </Link>
        <Link to="/documents/e-signature" className="sub-nav-link">
          E-Signature
        </Link>
        <Link to="/documents/scanning" className="sub-nav-link">
          Document Scanning
        </Link>
        <Link to="/documents/workflow" className="sub-nav-link">
          Workflow
        </Link>
        <Link to="/documents/search" className="sub-nav-link">
          Search & Retrieval
        </Link>
        <Link to="/documents/access-control" className="sub-nav-link">
          Access Control
        </Link>
        <Link to="/documents/analytics" className="sub-nav-link">
          Analytics
        </Link>
      </nav>

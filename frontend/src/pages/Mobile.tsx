/**
 * WF-COMP-XXX | Mobile.tsx - Mobile
 * Purpose: React component for Mobile functionality
 * Dependencies: react
...
const Applications = lazy(() => import('./mobile/Applications'));
const Tablet = lazy(() => import('./mobile/Tablet'));
const RemoteDesktop = lazy(() => import('./mobile/RemoteDesktop'));
const FieldService = lazy(() => import('./mobile/FieldService'));
const EmergencyAccess = lazy(() => import('./mobile/EmergencyAccess'));
const Offline = lazy(() => import('./mobile/Offline'));
const MobileReporting = lazy(() => import('./mobile/MobileReporting'));
const Sync = lazy(() => import('./mobile/Sync'));

  ...
  return (
    <div className="page">
      <header className="page-header">
        ...
        <p className="page-subtitle">Compose and review email messages sent to clients</p>
      </header>
      ...
      <div className="table-container">
        {isLoading ? (
          ...
          <div role="status" aria-live="polite">
            <p>No emails found. Compose one above to get started.</p>
          </div>
        ) : (
          <table className="data-table" role="table" aria-label="Email messages list">
            <thead>
              <tr>

/**
 * WF-COMP-INTEGRATIONS-007 | IntegrationsMain.tsx - Main integrations page
 * Purpose: Main integrations list and navigation page
 * Related: IntegrationsList component, integrations routes
...
const HL7FHIR = lazy(() => import('./HL7FHIR'));

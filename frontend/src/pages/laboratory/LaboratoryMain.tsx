/**
 * WF-COMP-LABORATORY-007 | LaboratoryMain.tsx - Main laboratory page
 * Purpose: Main laboratory list and navigation page
 * Related: LaboratoryList component, laboratory routes
...
const InHouse = lazy(() => import('./InHouse'));
const External = lazy(() => import('./External'));
const TestCatalog = lazy(() => import('./TestCatalog'));
const SampleTracking = lazy(() => import('./SampleTracking'));
const Results = lazy(() => import('./Results'));
const QualityAssurance = lazy(() => import('./QualityAssurance'));
const LabEquipment = lazy(() => import('./LabEquipment'));

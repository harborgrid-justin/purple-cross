/**
 * WF-COMP-012 | PatientsMain.tsx - Main patients page
 * Purpose: Main patients list and navigation page
 * Related: PatientsList component, patients routes
...
const HealthStatus = lazy(() => import('./HealthStatus'));
const Lifecycle = lazy(() => import('./Lifecycle'));
const BreedInfo = lazy(() => import('./BreedInfo'));

/**
 * WF-COMP-PRESCRIPTIONS-007 | PrescriptionsMain.tsx - Main prescriptions page
 * Purpose: Main prescriptions list and navigation page
 * Related: PrescriptionsList component, prescriptions routes
...
const EPrescribing = lazy(() => import('./EPrescribing'));
const MedicationDatabase = lazy(() => import('./MedicationDatabase'));
const History = lazy(() => import('./History'));
const DosageCalculator = lazy(() => import('./DosageCalculator'));
...
const Compounding = lazy(() => import('./Compounding'));
...
export default PrescriptionsMain;

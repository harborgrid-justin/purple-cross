/**
 * WF-COMP-REPORTS-007 | ReportsMain.tsx - Main reports page
 * Purpose: Main reports list and navigation page
 * Related: ReportsList component, reports routes
...
const Operational = lazy(() => import('./Operational'));
const Clinical = lazy(() => import('./Clinical'));

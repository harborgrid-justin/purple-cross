/**
 * WF-COMP-STAFF-007 | StaffMain.tsx - Main staff page
 * Purpose: Main staff list and navigation page
 * Related: StaffList component, staff routes
...
const HRDocuments = lazy(() => import('./HRDocuments'));
